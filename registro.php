    ...
    if (empty($errors)) {
        ...
        if ($id > 0) {
            ...
            if ($idUsuario > 0) {
                ...
                $asunto = "Activar cuenta - Óptica Sooleil";
                $cuerpo = "Estimado $nombres: <br> Para continuar con el proceso de registro es indispensable de clic en el siguiente link <a href='$url'>Activar cuenta</a>";
