...
<head>
    ...
    <title>Inicio de sesión - Óptica Sooleil</title>
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-2">Administración de Óptica Sooleil</h3>
                                </div>
                                <div class="card-body">
                ...
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">
                            <?php echo date('Y'); ?> &copy; <a href="https://github.com/EdisonGonzalezA">Grupo6</a>
                        </div>
                    </div>
                </div>
            </footer>
